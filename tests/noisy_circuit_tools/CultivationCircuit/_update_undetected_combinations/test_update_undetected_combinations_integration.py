...
def test_multiple_effects(dummy_fault_count, update_undetected_combinations):
    orig_fault_count = fault_count
    try:
        globals()['fault_count'] = dummy_fault_count
        ...
        update_undetected_combinations(undetected_combinations, effect_1, candidate_1)
...
def test_length_2_candidates(dummy_fault_count, update_undetected_combinations):
    orig_fault_count = fault_count
    effect = "XY"
    try:
        globals()['fault_count'] = dummy_fault_count
